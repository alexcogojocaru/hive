...
type xdpProgramSpecs struct {
	Ratelimit *ebpf.ProgramSpec `ebpf:"ratelimit"`
}
...
type xdpMapSpecs struct {
	HiveRatelimit *ebpf.MapSpec `ebpf:"hive_ratelimit"`
}
...
// It can be passed to loadXdpObjects or ebpf.CollectionSpec.LoadAndAssign.
type xdpMaps struct {
	HiveRatelimit *ebpf.Map `ebpf:"hive_ratelimit"`
}
...
type xdpPrograms struct {
	Ratelimit *ebpf.Program `ebpf:"ratelimit"`
}
